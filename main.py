...
<body> </div> <div class="containor">
    ...
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">🅴🅽🅹🅾🆈 -- 🆂︎🅴︎🆁︎🆅︎🅴︎🆁︎</span>.</span></p>
  </p>
    </footer>
    </div>
</div>
   ...
   <style>
    ...
    .boxed-text {
      ...
      padding: 05px; /* Add some padding inside the box */
...
<body>
  <div>
    ...
    <!-- Your text box content here -->
    <footer class="footer">
      <p><span class="boxed-text"><span class="color-span">𝗠𝗔𝗗𝗘 𝗕𝗬 𝐀𝐋𝐄𝐗 </span></span></p>
    </footer>
    </div>
</div>
